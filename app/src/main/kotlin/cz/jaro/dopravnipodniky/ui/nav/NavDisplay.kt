...
import cz.jaro.dopravnipodniky.ui.garaz.GarazScreen
import cz.jaro.dopravnipodniky.ui.garaz.obchod.ObchodScreen
...
fun NavDisplay(
    ...
    NavDisplay(
        ...
        entryProvider = entryProvider {
            ...
            entry<Route.Shop>(metadata = metadata) { ObchodScreen(navigator) }
