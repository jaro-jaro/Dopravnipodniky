...
private val autobusy = listOf(
    TypBusu(
        ...
        vyrobce = SKODA,
        kapacita = 63,
        maxRychlost = 65.kilometersPerHour,
        maxNaklady = 250.penezZaMin,
        cena = 100_000.penez,
        delka = 10.81.dp,
        sirka = 2.500.dp,
        vydrz = 140.hours,
    ...
    TypBusu(
        ...
        vyrobce = KAROSA,
        kapacita = 96,
        maxRychlost = 70.kilometersPerHour,
    ...
    TypBusu(
        ...
        vyrobce = IKARUS,
        kapacita = 40,
        maxRychlost = 60.kilometersPerHour,
        maxNaklady = 300.penezZaMin,
        cena = 60_000.penez,
        delka = 8.4.dp,
        sirka = 2.300.dp,
        vydrz = 100.hours,
    ...
    TypBusu(
        ...
        vyrobce = IKARUS,
        kapacita = 77,
        maxRychlost = 78.kilometersPerHour,
        maxNaklady = 160.penezZaMin,
        cena = 80_000.penez,
        delka = 9.445.dp,
        sirka = 2.500.dp,
        vydrz = 100.hours,
    ...
    TypBusu(
        ...
        vyrobce = IKARUS,
        kapacita = 87,
        maxRychlost = 75.kilometersPerHour,
        maxNaklady = 150.penezZaMin,
        cena = 100_000.penez,
        delka = 11.395.dp,
        sirka = 2.500.dp,
    ...
    TypBusu(
        ...
        vyrobce = IKARUS,
        kapacita = 46,
        maxRychlost = 76.kilometersPerHour,
        maxNaklady = 100.penezZaMin,
        cena = 90_000.penez,
        delka = 7.3.dp,
        sirka = 2.500.dp,
    ...
    TypBusu(
        ...
        vyrobce = IKARUS,
        kapacita = 101,
        maxRychlost = 82.kilometersPerHour,
        maxNaklady = 99.penezZaMin,
        cena = 115_000.penez,
        delka = 11.6.dp,
        sirka = 2.500.dp,
    ...
    TypBusu(
        ...
        vyrobce = IKARUS,
        kapacita = 168,
        maxRychlost = 90.kilometersPerHour,
        maxNaklady = 98.penezZaMin,
        cena = 155_000.penez,
        delka = 17.63.dp,
        clanky = listOf(
    ...
    TypBusu(
        ...
        vyrobce = VOLVO,
        kapacita = 138,
        maxRychlost = 80.kilometersPerHour,
    ...
    TypBusu(
        ...
        vyrobce = IRISBUS,
        kapacita = 69,
        maxRychlost = 85.kilometersPerHour,
        maxNaklady = 77.penezZaMin,
        cena = 120_000.penez,
        delka = 12.962.dp,
        sirka = 2.550.dp,
    ...
    TypBusu(
        ...
        vyrobce = IVECO,
        kapacita = 38,
        maxRychlost = 30.kilometersPerHour,
        maxNaklady = 95.penezZaMin,
        cena = 70_000.penez,
        delka = 7.765.dp,
        sirka = 2.300.dp,
        vydrz = 144.hours,
...
private val trolejbusy = listOf(
    TypBusu(
        ...
        vyrobce = SKODA,
        kapacita = 73,
        maxRychlost = 46.kilometersPerHour,
        maxNaklady = 200.penezZaMin,
        cena = 80_000.penez,
        delka = 10.330.dp,
        sirka = 2.350.dp,
    ...
    TypBusu(
        ...
        vyrobce = PRAGA,
        kapacita = 80,
        maxRychlost = 50.kilometersPerHour,
        maxNaklady = 200.penezZaMin,
        cena = 80_000.penez,
        delka = 10.200.dp,
        sirka = 2.450.dp,
    ...
    TypBusu(
        ...
        vyrobce = TATRA,
        kapacita = 80,
        maxRychlost = 45.kilometersPerHour,
        maxNaklady = 200.penezZaMin,
        cena = 80_000.penez,
        delka = 10.700.dp,
        sirka = 2.420.dp,
    ...
    TypBusu(
        ...
        vyrobce = SKODA,
        kapacita = 82,
        maxRychlost = 56.kilometersPerHour,
        maxNaklady = 100.penezZaMin,
        cena = 100_000.penez,
        delka = 10.700.dp,
        sirka = 2.500.dp,
